...
const Explanation = () => {
    ...
    return (
        <div className=" p-3 rounded-3xl text-xl space-y-5 ">
            <div className="bg-gradient-to-b from-amber-400 to-amber-600 p-3 rounded-3xl text-center text-4xl font-bold text-black underline shadow-lg border-black border-4">
                <h1>Welcome</h1>
            </div>
            ...
            <div>
                <div className='w-fit text-xl rounded-t-3xl bg-gradient-to-b from-amber-400 to-amber-600 p-2 border-2'>
                    Input:
                </div>
